---
article_html: "<p>If you are using a local <a href=\"https://turso.tech/libsql\">libsql</a>
  database, it is quite easy to query the database, but for a remote or a database
  on a hosted cloud platform like <a href=\"https://turso.tech/\">turso</a>, we can
  use other clients or the api itself to query the data.</p>\n<p>We can use the turso
  cli to get the authentication token for the database and then query the database.</p>\n<h2>Turso
  CLI</h2>\n<p>Using the <a href=\"https://docs.turso.tech/reference/turso-cli\">turso-cli</a>
  to access the turso platform. We will use turso cli to create a libsql database,
  create authentication tokens, and query the db.</p>\n<h3>Create a database (it's
  optional, you might already have a database)</h3>\n<pre class='wrapper'>\n\n<div
  ...
  db create\n</pre></div>\n\n</pre>\n\n<p>You will get a database on the turso cloud
  platform with some random interesting name like a passphrase.</p>\n<p>Use the command
  <code>turso db list</code> and copy the URL</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n<div class='language-bar'>graphql</div>\n<div class=\"highlight\"><pre><span></span>DB_URL=dbname-orgname.turso.io\n</pre></div>\n\n</pre>\n\n<h3>Create
  an authentication token for a particular database</h3>\n<pre class='wrapper'>\n\n<div
  class='copy-wrapper'>\n\n<button class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n<div class='language-bar'>bash</div>\n<div class=\"highlight\"><pre><span></span>turso
  db tokens create db_name\n</pre></div>\n\n</pre>\n\n<p>Copy the JWT token and this
  will be used as a authentication token when accessing the remote database in the
  turso cloud.</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
  class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  class=\"nv\">TOKEN</span><span class=\"o\">=</span>abcdef.12345.wxyz\n<span class=\"nv\">DB_URL</span><span
  class=\"o\">=</span>dbname-orgname.turso.io\n</pre></div>\n\n</pre>\n\n<ul>\n<li>Querying
  the database using curl or other <a href=\"https://docs.turso.tech/libsql/client-access\">api
  clients</a></li>\n</ul>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
  class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  -s -H <span class=\"s2\">&quot;Authorization: bearer </span><span class=\"nv\">$TOKEN</span><span
  class=\"s2\">&quot;</span> <span class=\"se\">\\</span>\n     -d <span class=\"s1\">&#39;{&quot;statements&quot;:
  [&quot;SELECT name FROM sqlite_master WHERE type=\\&quot;table\\&quot;;&quot;]}&#39;</span>
  <span class=\"se\">\\</span>\n     <span class=\"nv\">$DB_URL</span>\n</pre></div>\n\n</pre>\n\n<p>We
  can use <code>curl</code> or any api client tools to send queries to the database
  hosted on the turso platform. We need to provide the JWT token in the <code>Authorization</code>
  header to connect to that particular database. The request's body is a JSON string
  with a list of statements to query the database.</p>\n<pre class='wrapper'>\n\n<div
  class='copy-wrapper'>\n\n<button class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
  ...
  [&quot;user&quot;]\n                ]\n            }\n     }\n]\n</pre></div>\n\n</pre>\n\n<p>The
  result is a list of key-value pairs as <code>columns</code> and <code>rows</code>
  for each of the statements in the body. The columns are a list of column names requested
  in the query, and the rows are a list of rows where each row is a list of field
  values from the query.</p>\n<div class='prevnext'>\n    <style type='text/css'>\n
...
cover: ''
date: 2023-11-15
datetime: 2023-11-15 00:00:00+00:00
...
edit_link: https://github.com/mr-destructive/meetgor.com/edit/gh-pages/blog/tils/2023-11-15-libsql-remote-query.md
html: "<p>If you are using a local <a href=\"https://turso.tech/libsql\">libsql</a>
  database, it is quite easy to query the database, but for a remote or a database
  on a hosted cloud platform like <a href=\"https://turso.tech/\">turso</a>, we can
  use other clients or the api itself to query the data.</p>\n<p>We can use the turso
  cli to get the authentication token for the database and then query the database.</p>\n<h2>Turso
  ...
  stroke-width=&quot;1.5&quot; stroke-linecap=&quot;round&quot; stroke-linejoin=&quot;round&quot;&gt;&lt;/path&gt;\n
  \   &lt;/svg&gt;\n&lt;/a&gt;\n</code></pre>\n  </div>"
long_description: If you are using a local  We can use the turso cli to get the authentication
  token for the database and then query the database. Using the  You will get a database
  on the turso cloud platform with some random interesting name like a passphrase.
  Use t
now: 2024-06-23 15:29:54.472149
path: blog/tils/2023-11-15-libsql-remote-query.md
