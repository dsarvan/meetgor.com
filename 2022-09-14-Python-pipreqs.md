---
article_html: "<h2>Introduction</h2>\n<p><a href=\"https://pypi.org/project/pipreqs/\">Pipreqs</a>
  is a python package that allows us to list all the pacakges which are imported in
  a python project. This is a great package for reducing the amount of redundant packages
  for a project.</p>\n<h2>Install pipreqs</h2>\n<p>You can install pipreqs with one
  of the many ways with pip, pipx, or any other pacakge management tool. I personally
  use pipreqs with <code>pipx</code> as it remains isolated from the rest of my project
  dependencies.</p>\n<h3>Using simple pip install</h3>\n<p>We can install with pip
  by creating a virtual environment or in a existing virtual environment.</p>\n<pre
  ...
  \       \n\n<div class=\"highlight\"><pre><span></span>pip install virtualenv venv\nsource
  venv/bin/activate\n\npip install pipreqs\n</pre></div>\n\n</pre>\n\n<h3>Using pipx</h3>\n<p>We
  can install pipreqs with pipx. <a href=\"https://pypi.org/project/pipx/\">Pipx</a>
  is also a python package but used as a tool to install any cli specific tool with
  the isolated environment.</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n\n<div class=\"highlight\"><pre><span></span>pipx install pipreqs\npipx
  run pipreqs\n</pre></div>\n\n</pre>\n\n<h2>Using pipreqs</h2>\n<p>We need to specify
  the encoding, which is used for reading the files while capturing the imports from
  the project.</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
  class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n\n<div class=\"highlight\"><pre><span></span>pipx run pipreqs --encoding=utf-8
  .\n</pre></div>\n\n</pre>\n\n<p>Additionaly, we can specify the <code>path</code>
  or filename where it will be used to save the imported packages. The <code>--savepath</code>
  option takes in the path to the file where you want to generate the list of the
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n\n<div class=\"highlight\"><pre><span></span>pipx run pipreqs --encoding=utf-8
  --savepath reqs.txt . \n</pre></div>\n\n</pre>\n\n<p>Though this doesn't guarentee
  all the requirements for a file, it is really helpful for explicitly used packages
  in the python project.</p>\n<div class='prevnext'>\n    <style type='text/css'>\n
...
cover: ''
date: 2022-09-14
datetime: 2022-09-14 00:00:00+00:00
...
edit_link: https://github.com/mr-destructive/meetgor.com/edit/gh-pages/blog/tils/2022-09-14-Python-pipreqs.md
html: "<h2>Introduction</h2>\n<p><a href=\"https://pypi.org/project/pipreqs/\">Pipreqs</a>
  ...
  stroke-width=&quot;1.5&quot; stroke-linecap=&quot;round&quot; stroke-linejoin=&quot;round&quot;&gt;&lt;/path&gt;\n
  \   &lt;/svg&gt;\n&lt;/a&gt;\n</code></pre>\n  </div>"
long_description: You can install pipreqs with one of the many ways with pip, pipx,
  or any other pacakge management tool. I personally use pipreqs with  We can install
  with pip by creating a virtual environment or in a existing virtual environment.
  We can install pipr
now: 2024-06-23 15:29:54.472146
path: blog/tils/2022-09-14-Python-pipreqs.md
slug: python-pipreqs
